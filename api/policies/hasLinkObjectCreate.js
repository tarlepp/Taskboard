// api/policies/hasLinkObjectCreate.js

/**
 * Policy to check if user can create new link object or not. Actual check is done by one
 ...
 */
module.exports = function hasLinkObjectCreate(request, response, next) {
    sails.log.verbose(" POLICY - api/policies/hasLinkObjectCreate.js");
