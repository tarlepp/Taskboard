// api/policies/hasExcludeSprintDayAdmin.js

/**
 * Policy to check if user has admin access to specified sprint exclude days or not.
 * Actual check is done by one of following internal AuthService methods;
 *
 *  - hasSprintAdmin
 *
 ...
 */
module.exports = function hasExcludeSprintDayAdmin(request, response, next) {
    sails.log.verbose(" POLICY - api/policies/hasExcludeSprintDayAdmin.js");
