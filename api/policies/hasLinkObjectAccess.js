// api/policies/hasLinkObjectAccess.js

/**
 * Policy to check if user has access to specified link object or not. Actual check is
 ...
 */
module.exports = function hasLinkObjectAccess(request, response, next) {
    sails.log.verbose(" POLICY - api/policies/hasLinkObjectAccess.js");
